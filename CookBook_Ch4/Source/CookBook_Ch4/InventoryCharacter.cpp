...
void AInventoryCharacter::Tick(float DeltaTime)
{
	...
	if (!MovementInput.IsZero()) {
		...
		/*GEngin->AddOnScreenDebugMessage(-1,1,FColor::Red,
...
void AInventoryCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	PlayerInputComponent->BindAxis("PithCamera", this, &AInventoryCharacter::PitchCamera);
	PlayerInputComponent->BindAxis("YawCamera", this, &AInventoryCharacter::YawCamera);
}
